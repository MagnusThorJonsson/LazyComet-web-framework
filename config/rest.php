...
|
*/
$config['rest_realm'] = "I'm on the Road!";
...
|
*/
$config['rest_valid_logins'] = array('admin' => 'thisisnotinuse');
...
$config['rest_hmac_key_name'] = 'X-HMAC';
...
|
*/
$config['rest_limits_table'] = 'apilimits';
